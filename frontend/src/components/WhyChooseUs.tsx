...
//                 <div className="absolute top-0 left-0 w-96 h-96 bg-blue-200 blur-3xl opacity-40 animate-pulse rounded-full"></div>
//                 <div className="absolute bottom-0 right-0 w-96 h-96 bg-purple-200 blur-3xl opacity-40 animate-pulse rounded-full"></div>
//             </div>
...
//                         <div className="p-4 border rounded-xl">Tailored Solutions</div>

//                         <div className="p-4 border rounded-xl">Proven Expertise</div>

//                         <div className="p-4 border rounded-xl">Data-Driven Results</div>

//                         <div className="p-4 border rounded-xl">Innovative Strategies</div>
