    ...
    <div className="relative min-h-screen bg-dark-black overflow-hidden font-sans text-white pb-24">
      ...
      <section className="relative pt-12 pb-16 text-center max-w-4xl mx-auto px-6">
        ...
        >
          ...
          <span className="text-xs font-bold text-accent-cyan uppercase tracking-[0.2em]">Legal Compliance</span>
        </motion.div>
          ...
          <div className="glass-card border border-white/10 rounded-[2.5rem] p-8 md:p-12 space-y-12 bg-white/[0.01]">
            ...
            <section className="space-y-4">
              ...
              <div className="text-white/70 leading-relaxed space-y-4 text-sm md:text-base">
                ...
                <div className="pl-4 border-l-2 border-accent-cyan/30 space-y-3">
                  <p>
            ...
            <section className="space-y-4">
              ...
              <div className="text-white/70 leading-relaxed space-y-4 text-sm md:text-base">
                ...
                <p>
                  ...
                  <a href="/cookie-policy" className="text-accent-cyan hover:underline font-semibold">
                    Cookie Policy
                  </a>.
                </p>
              </div>
