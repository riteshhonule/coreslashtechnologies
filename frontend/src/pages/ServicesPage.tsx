    ...
    <div className="w-full min-h-screen bg-background text-foreground overflow-hidden">
      ...
      >
        ...
        <div className="relative z-10 max-w-[1400px] w-full text-left space-y-4 md:space-y-5">
          ...
          >
            CoreSlash Technologies provides software development services for scalable AI solutions, high-performance web platforms, mobile applications, cloud infrastructure, custom software systems, and real-time business intelligence, serving enterprise clients and <Link to="/top-it-companies-in-belagavi" className="text-blue-400 font-semibold hover:underline">IT companies in Belgaum</Link>.
          </motion.p>
