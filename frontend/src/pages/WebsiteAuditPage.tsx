        ...
        <section className="max-w-4xl mx-auto px-4 pb-20">
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 backdrop-blur-md">
            ...
            <p className="text-sm text-slate-400 mb-8">
              Performing live HTTP fetch, parsing DOM structure, and measuring browser performance via Chrome DevTools Protocol.
            </p>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Real browser performance metrics measured via Chrome DevTools Protocol engine</p>
              </div>
