    ...
    return (
        <div className="min-h-screen bg-[#F9FAFB] pt-4 text-gray-900">
            ...
            <div className="max-w-4xl mx-auto px-6 py-10 md:py-20">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary-indigo/5 text-secondary-indigo border border-secondary-indigo/15 mb-6">
                ...
                <div className="space-y-4">
                    {faqs.map((faq, index) => (
                        <motion.details
                            ...
                            className="group bg-white rounded-2xl border border-gray-200/60 overflow-hidden shadow-sm hover:shadow-md transition-all duration-300"
                        >
                            <summary className="flex items-center justify-between p-6 cursor-pointer list-none">
                                <h3 className="text-lg font-bold text-gray-900 pr-4">{faq.q}</h3>
                                <ChevronDownIcon className="w-5 h-5 text-gray-400 group-open:rotate-180 transition-transform duration-300" />
                            </summary>
                ...
                <motion.div
                    ...
                    className="mt-20 p-10 bg-white border border-gray-200/60 rounded-[2.5rem] text-center text-gray-900 relative overflow-hidden shadow-xl shadow-gray-200/30"
                >
                    <div className="relative z-10">
                        ...
                        <a
                            href="/contact"
                            className="inline-block px-10 py-4 btn-primary-glow text-white text-base font-bold rounded-xl"
                        >
                            Get in Touch
                        </a>
                    </div>
                    <div className="absolute top-0 right-0 w-64 h-64 bg-primary-purple/3 rounded-full -mr-20 -mt-20 blur-3xl pointer-events-none" />
                    <div className="absolute bottom-0 left-0 w-64 h-64 bg-secondary-indigo/3 rounded-full -ml-20 -mb-20 blur-3xl pointer-events-none" />
                </motion.div>
            </div>
        </div>
    );
